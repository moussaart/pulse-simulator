...
def save_policy(policy_net, prefix="policy_switch"):
...
def main():
    ...
    print("================================================================")
    print(f"  R_t = alpha*(e_shadow_imu - e_fusion) + (1-alpha)*(1 - (E_t-E_min)/(E_max-E_min))")
    print(f"  alpha = {ALPHA}  |  Energy bounds computed dynamically from tau={TAU_S}s")
